    ...
    itemTpl: [
        '<div class="timeline-item{userId:this.cls(values,parent[xindex-2],xindex-1,xcount)}">' +
            ...
            '<div class="profile-pic-wrap">' +
                '<img src="fashion/resources/images/user-profile/{userId}.png" alt="Smiley face">' +
            ...
            '<tpl if="notificationType == \'image_sharing\'">' +
                '<div class="line-wrap">' +
                    '<div class="contents-wrap">' +
                        ...
                        '<img src="fashion/resources/images/img2.jpg" class="shared-img" alt="Smiley face">' +
                    '</div>' +
                '</div>' +
                ...
                '<div class="line-wrap">' +
                    '<div class="contents-wrap">' +
                        '<div class="followed-by">' +
                            '<img src="fashion/resources/images/user-profile/10.png" alt="Smiley face">' +
            ...
            '<tpl elseif="notificationType == \'like\'">' +
                '<div class="line-wrap">' +
                    '<div class="contents-wrap">' +
                        '<div class="followed-by">' +
                            '<img src="fashion/resources/images/user-profile/1.png" alt="Smiley face">' +
