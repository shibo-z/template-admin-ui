                    ...
                    renderer: function(value, metaData, record, rowIndex) {
                        ...
                        if (rowIndex === 3) {
                            page = "<div class='imageRowCls'>" +
                                "<img src='fashion/resources/images/img1.jpg' alt='Dandelion' " +
                                    "class='search-result-attachment'>" +
                                "<img src='fashion/resources/images/img2.jpg' alt='Landscape' " +
                                    "class='search-result-attachment'>" +
                                "</div>";
                        }
                        return page;
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value) {
                        return "<img src='fashion/resources/images/user-profile/" + value + "' alt='Profile Pic' height='40px' width='40px'>";
                    },
                    width: 75,
