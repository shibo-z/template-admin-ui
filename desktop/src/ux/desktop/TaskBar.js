 ...
 */
Ext.define('Admin.ux.desktop.TaskBar', {
    ...
    requires: [
        ...
        'Admin.ux.desktop.StartMenu'
    ],

    alias: 'widget.uxtaskbar',
    ...
    initComponent: function() {
        ...
        me.startMenu = new Admin.ux.desktop.StartMenu(me.startConfig);
 ...
 */
Ext.define('Admin.ux.desktop.TrayClock', {
    extend: 'Ext.toolbar.TextItem',

    alias: 'widget.uxtrayclock',
